// <auto-generated/>
using Marvel.Client.Events.Item;
...
namespace Marvel.Client.Events {
    ...
    public class EventsRequestBuilder : BaseRequestBuilder {
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,series*,comics*,stories*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,series*,comics*,stories*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
