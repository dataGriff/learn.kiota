...
using System;
namespace Marvel.Client.Events.Item.Creators {
    /// <summary>
    /// Builds and executes requests for operations under \events\{eventId}\creators
    /// </summary>
    public class CreatorsRequestBuilder : BaseRequestBuilder {
        ...
        public CreatorsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/events/{eventId}/creators{?firstName*,middleName*,lastName*,suffix*,nameStartsWith*,firstNameStartsWith*,middleNameStartsWith*,lastNameStartsWith*,modifiedSince*,comics*,series*,stories*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreatorsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreatorsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/events/{eventId}/creators{?firstName*,middleName*,lastName*,suffix*,nameStartsWith*,firstNameStartsWith*,middleNameStartsWith*,lastNameStartsWith*,modifiedSince*,comics*,series*,stories*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
