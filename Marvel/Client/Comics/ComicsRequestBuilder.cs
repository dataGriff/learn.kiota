// <auto-generated/>
using Marvel.Client.Comics.Item;
...
using System;
namespace Marvel.Client.Comics {
    /// <summary>
    /// Builds and executes requests for operations under \comics
    /// </summary>
    public class ComicsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Marvel.Client.comics.item collection</summary>
        /// <param name="position">A single comic.</param>
        public WithComicItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("comicId", position);
            return new WithComicItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public ComicsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/comics{?format*,formatType*,noVariants*,dateDescriptor*,dateRange*,diamondCode*,digitalId*,upc*,isbn*,ean*,issn*,hasDigitalIssue*,modifiedSince*,creators*,characters*,series*,events*,stories*,sharedAppearances*,collaborators*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ComicsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ComicsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/comics{?format*,formatType*,noVariants*,dateDescriptor*,dateRange*,diamondCode*,digitalId*,upc*,isbn*,ean*,issn*,hasDigitalIssue*,modifiedSince*,creators*,characters*,series*,events*,stories*,sharedAppearances*,collaborators*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class ComicsRequestBuilderGetQueryParameters {
            ...
            /// <summary>Return only comics in which the specified creators worked together (for example in which BOTH Stan Lee and Jack Kirby did work). Accepts a comma-separated list of ids.</summary>
...
#nullable restore
            ...
            public string ModifiedSince { get; set; }
#endif
            /// <summary>Exclude variants (alternate covers, secondary printings, director&apos;s cuts, etc.) from the result set.</summary>
...
#nullable restore
            ...
            /// <summary>Return only comics in which the specified characters appear together (for example in which BOTH Spider-Man and Wolverine appear). Accepts a comma-separated list of ids.</summary>
