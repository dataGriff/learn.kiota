...
using System;
namespace Marvel.Client.Comics.Item.Characters {
    /// <summary>
    /// Builds and executes requests for operations under \comics\{comicId}\characters
    /// </summary>
    public class CharactersRequestBuilder : BaseRequestBuilder {
        ...
        public CharactersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/comics/{comicId}/characters{?name*,nameStartsWith*,modifiedSince*,series*,events*,stories*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CharactersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CharactersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/comics/{comicId}/characters{?name*,nameStartsWith*,modifiedSince*,series*,events*,stories*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
