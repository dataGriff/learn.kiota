...
using System;
namespace Marvel.Client.Comics.Item.Events {
    /// <summary>
    /// Builds and executes requests for operations under \comics\{comicId}\events
    /// </summary>
    public class EventsRequestBuilder : BaseRequestBuilder {
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/comics/{comicId}/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,series*,stories*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/comics/{comicId}/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,series*,stories*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
