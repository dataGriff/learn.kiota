...
using System;
namespace Marvel.Client.Creators.Item.Stories {
    /// <summary>
    /// Builds and executes requests for operations under \creators\{creatorId}\stories
    /// </summary>
    public class StoriesRequestBuilder : BaseRequestBuilder {
        ...
        public StoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/creators/{creatorId}/stories{?modifiedSince*,comics*,series*,events*,characters*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new StoriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StoriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/creators/{creatorId}/stories{?modifiedSince*,comics*,series*,events*,characters*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
