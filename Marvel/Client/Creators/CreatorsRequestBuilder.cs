// <auto-generated/>
using Marvel.Client.Creators.Item;
...
namespace Marvel.Client.Creators {
    ...
    public class CreatorsRequestBuilder : BaseRequestBuilder {
        ...
        public CreatorsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/creators{?firstName*,middleName*,lastName*,suffix*,nameStartsWith*,firstNameStartsWith*,middleNameStartsWith*,lastNameStartsWith*,modifiedSince*,comics*,series*,events*,stories*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreatorsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreatorsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/creators{?firstName*,middleName*,lastName*,suffix*,nameStartsWith*,firstNameStartsWith*,middleNameStartsWith*,lastNameStartsWith*,modifiedSince*,comics*,series*,events*,stories*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
