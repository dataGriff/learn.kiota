...
using System;
namespace Marvel.Client.Stories.Item.Characters {
    /// <summary>
    /// Builds and executes requests for operations under \stories\{storyId}\characters
    /// </summary>
    public class CharactersRequestBuilder : BaseRequestBuilder {
        ...
        public CharactersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/stories/{storyId}/characters{?name*,nameStartsWith*,modifiedSince*,comics*,series*,events*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CharactersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CharactersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/stories/{storyId}/characters{?name*,nameStartsWith*,modifiedSince*,comics*,series*,events*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
