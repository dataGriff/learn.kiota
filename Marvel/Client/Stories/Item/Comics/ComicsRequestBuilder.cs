...
using System;
namespace Marvel.Client.Stories.Item.Comics {
    /// <summary>
    /// Builds and executes requests for operations under \stories\{storyId}\comics
    /// </summary>
    public class ComicsRequestBuilder : BaseRequestBuilder {
        ...
        public ComicsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/stories/{storyId}/comics{?format*,formatType*,noVariants*,dateDescriptor*,dateRange*,diamondCode*,digitalId*,upc*,isbn*,ean*,issn*,hasDigitalIssue*,modifiedSince*,creators*,characters*,series*,events*,sharedAppearances*,collaborators*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ComicsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ComicsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/stories/{storyId}/comics{?format*,formatType*,noVariants*,dateDescriptor*,dateRange*,diamondCode*,digitalId*,upc*,isbn*,ean*,issn*,hasDigitalIssue*,modifiedSince*,creators*,characters*,series*,events*,sharedAppearances*,collaborators*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
