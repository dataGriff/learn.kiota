...
using System;
namespace Marvel.Client.Stories.Item.Events {
    /// <summary>
    /// Builds and executes requests for operations under \stories\{storyId}\events
    /// </summary>
    public class EventsRequestBuilder : BaseRequestBuilder {
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/stories/{storyId}/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,series*,comics*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/stories/{storyId}/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,series*,comics*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
