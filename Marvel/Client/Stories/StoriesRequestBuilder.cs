// <auto-generated/>
using Marvel.Client.Stories.Item;
...
namespace Marvel.Client.Stories {
    ...
    public class StoriesRequestBuilder : BaseRequestBuilder {
        ...
        public StoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/stories{?modifiedSince*,comics*,series*,events*,creators*,characters*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new StoriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StoriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/stories{?modifiedSince*,comics*,series*,events*,creators*,characters*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
