...
using System;
namespace Marvel.Client.Series.Item.Events {
    /// <summary>
    /// Builds and executes requests for operations under \series\{seriesId}\events
    /// </summary>
    public class EventsRequestBuilder : BaseRequestBuilder {
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/series/{seriesId}/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,comics*,stories*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/series/{seriesId}/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,comics*,stories*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
