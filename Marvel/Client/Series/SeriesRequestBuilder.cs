// <auto-generated/>
using Marvel.Client.Series.Item;
...
namespace Marvel.Client.Series {
    ...
    public class SeriesRequestBuilder : BaseRequestBuilder {
        ...
        public SeriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/series{?title*,titleStartsWith*,startYear*,modifiedSince*,comics*,stories*,events*,creators*,characters*,seriesType*,contains*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SeriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SeriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/series{?title*,titleStartsWith*,startYear*,modifiedSince*,comics*,stories*,events*,creators*,characters*,seriesType*,contains*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
