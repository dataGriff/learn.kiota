...
using System;
namespace Marvel.Client.Characters.Item.Comics {
    /// <summary>
    /// Builds and executes requests for operations under \characters\{characterId}\comics
    /// </summary>
    public class ComicsRequestBuilder : BaseRequestBuilder {
        ...
        public ComicsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/characters/{characterId}/comics{?format*,formatType*,noVariants*,dateDescriptor*,dateRange*,diamondCode*,digitalId*,upc*,isbn*,ean*,issn*,hasDigitalIssue*,modifiedSince*,creators*,series*,events*,stories*,sharedAppearances*,collaborators*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ComicsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ComicsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/characters/{characterId}/comics{?format*,formatType*,noVariants*,dateDescriptor*,dateRange*,diamondCode*,digitalId*,upc*,isbn*,ean*,issn*,hasDigitalIssue*,modifiedSince*,creators*,series*,events*,stories*,sharedAppearances*,collaborators*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
