// <auto-generated/>
using Marvel.Client.Characters.Item.Comics;
using Marvel.Client.Characters.Item.Events;
using Marvel.Client.Characters.Item.Series;
using Marvel.Client.Characters.Item.Stories;
...
using System;
namespace Marvel.Client.Characters.Item {
    /// <summary>
    /// Builds and executes requests for operations under \characters\{characterId}
    /// </summary>
    public class WithCharacterItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithCharacterItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/characters/{characterId}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithCharacterItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCharacterItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/characters/{characterId}", rawUrl) {
        }
        /// <summary>
