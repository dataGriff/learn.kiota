// <auto-generated/>
using KiotaPosts.Client.V1.Public.Comics.Item;
...
using System;
namespace KiotaPosts.Client.V1.Public.Comics {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\comics
    /// </summary>
    public class ComicsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the KiotaPosts.Client.v1.public.comics.item collection</summary>
        /// <param name="position">A single comic.</param>
        public WithComicItemRequestBuilder this[int position] { get {
        ...
        public WithComicItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("comicId", position);
            return new WithComicItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
