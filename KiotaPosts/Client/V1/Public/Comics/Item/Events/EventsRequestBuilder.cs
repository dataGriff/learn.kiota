...
using System;
namespace KiotaPosts.Client.V1.Public.Comics.Item.Events {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\comics\{comicId}\events
    /// </summary>
    public class EventsRequestBuilder : BaseRequestBuilder {
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/comics/{comicId}/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,series*,stories*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/comics/{comicId}/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,series*,stories*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
