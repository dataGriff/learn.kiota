// <auto-generated/>
using KiotaPosts.Client.V1.Public.Series.Item;
...
using System;
namespace KiotaPosts.Client.V1.Public.Series {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\series
    /// </summary>
    public class SeriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the KiotaPosts.Client.v1.public.series.item collection</summary>
        /// <param name="position">Filter by series title.</param>
        public WithSeriesItemRequestBuilder this[int position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("seriesId", position);
            return new WithSeriesItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>Gets an item from the KiotaPosts.Client.v1.public.series.item collection</summary>
        /// <param name="position">Filter by series title.</param>
        [Obsolete("This indexer is deprecated and will be removed in the next major version. Use the one with the typed parameter instead.")]
        public WithSeriesItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("seriesId", position);
            return new WithSeriesItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public SeriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/series{?title*,titleStartsWith*,startYear*,modifiedSince*,comics*,stories*,events*,creators*,characters*,seriesType*,contains*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SeriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SeriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/series{?title*,titleStartsWith*,startYear*,modifiedSince*,comics*,stories*,events*,creators*,characters*,seriesType*,contains*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
            ...
            public int?[] Stories { get; set; }
#endif
            /// <summary>Return only series matching the specified title.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
