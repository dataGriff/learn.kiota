...
using System;
namespace KiotaPosts.Client.V1.Public.Characters.Item.Series {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\characters\{characterId}\series
    /// </summary>
    public class SeriesRequestBuilder : BaseRequestBuilder {
        ...
        public SeriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/characters/{characterId}/series{?title*,titleStartsWith*,startYear*,modifiedSince*,comics*,stories*,events*,creators*,seriesType*,contains*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SeriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SeriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/characters/{characterId}/series{?title*,titleStartsWith*,startYear*,modifiedSince*,comics*,stories*,events*,creators*,seriesType*,contains*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
