...
using System;
namespace KiotaPosts.Client.V1.Public.Characters.Item.Events {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\characters\{characterId}\events
    /// </summary>
    public class EventsRequestBuilder : BaseRequestBuilder {
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/characters/{characterId}/events{?name*,nameStartsWith*,modifiedSince*,creators*,series*,comics*,stories*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/characters/{characterId}/events{?name*,nameStartsWith*,modifiedSince*,creators*,series*,comics*,stories*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
