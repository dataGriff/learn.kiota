// <auto-generated/>
using KiotaPosts.Client.V1.Public.Characters.Item;
...
using System;
namespace KiotaPosts.Client.V1.Public.Characters {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\characters
    /// </summary>
    public class CharactersRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the KiotaPosts.Client.v1.public.characters.item collection</summary>
        /// <param name="position">A single character id.</param>
        public WithCharacterItemRequestBuilder this[int position] { get {
        ...
        public CharactersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/characters{?name*,nameStartsWith*,modifiedSince*,comics*,series*,events*,stories*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CharactersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CharactersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/characters{?name*,nameStartsWith*,modifiedSince*,comics*,series*,events*,stories*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
