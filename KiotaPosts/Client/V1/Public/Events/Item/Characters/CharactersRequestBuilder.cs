...
using System;
namespace KiotaPosts.Client.V1.Public.Events.Item.Characters {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\events\{eventId}\characters
    /// </summary>
    public class CharactersRequestBuilder : BaseRequestBuilder {
        ...
        public CharactersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/events/{eventId}/characters{?name*,nameStartsWith*,modifiedSince*,comics*,series*,stories*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CharactersRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CharactersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/events/{eventId}/characters{?name*,nameStartsWith*,modifiedSince*,comics*,series*,stories*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
