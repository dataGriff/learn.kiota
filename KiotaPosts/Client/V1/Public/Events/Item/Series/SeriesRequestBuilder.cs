...
using System;
namespace KiotaPosts.Client.V1.Public.Events.Item.Series {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\events\{eventId}\series
    /// </summary>
    public class SeriesRequestBuilder : BaseRequestBuilder {
        ...
        public SeriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/events/{eventId}/series{?title*,titleStartsWith*,startYear*,modifiedSince*,comics*,stories*,creators*,characters*,seriesType*,contains*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SeriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SeriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/events/{eventId}/series{?title*,titleStartsWith*,startYear*,modifiedSince*,comics*,stories*,creators*,characters*,seriesType*,contains*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
