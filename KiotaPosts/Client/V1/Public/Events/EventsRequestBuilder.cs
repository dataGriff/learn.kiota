// <auto-generated/>
using KiotaPosts.Client.V1.Public.Events.Item;
...
using System;
namespace KiotaPosts.Client.V1.Public.Events {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\events
    /// </summary>
    public class EventsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the KiotaPosts.Client.v1.public.events.item collection</summary>
        /// <param name="position">A single event.</param>
        public WithEventItemRequestBuilder this[int position] { get {
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,series*,comics*,stories*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,series*,comics*,stories*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
            ...
            /// <summary>Return only events which match the specified name.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            [QueryParameter("name")]
...
#nullable restore
            ...
            public int?[] Series { get; set; }
#endif
            /// <summary>Return only events which take place in the specified stories (accepts a comma-separated list of ids).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
