...
using System;
namespace KiotaPosts.Client.V1.Public.Creators.Item.Stories {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\creators\{creatorId}\stories
    /// </summary>
    public class StoriesRequestBuilder : BaseRequestBuilder {
        ...
        public StoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/creators/{creatorId}/stories{?modifiedSince*,comics*,series*,events*,characters*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new StoriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StoriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/creators/{creatorId}/stories{?modifiedSince*,comics*,series*,events*,characters*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
            ...
            public int?[] Characters { get; set; }
#endif
            /// <summary>Return only stories contained in the specified comics (accepts a comma-separated list of ids).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
