// <auto-generated/>
using KiotaPosts.Client.V1.Public.Stories.Item;
...
using System;
namespace KiotaPosts.Client.V1.Public.Stories {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\stories
    /// </summary>
    public class StoriesRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the KiotaPosts.Client.v1.public.stories.item collection</summary>
        /// <param name="position">Filter by story id.</param>
        public WithStoryItemRequestBuilder this[int position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("storyId", position);
            return new WithStoryItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>Gets an item from the KiotaPosts.Client.v1.public.stories.item collection</summary>
        /// <param name="position">Filter by story id.</param>
        [Obsolete("This indexer is deprecated and will be removed in the next major version. Use the one with the typed parameter instead.")]
        public WithStoryItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("storyId", position);
            return new WithStoryItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public StoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/stories{?modifiedSince*,comics*,series*,events*,creators*,characters*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new StoriesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StoriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/stories{?modifiedSince*,comics*,series*,events*,creators*,characters*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
