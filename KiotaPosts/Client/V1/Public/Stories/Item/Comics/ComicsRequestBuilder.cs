...
using System;
namespace KiotaPosts.Client.V1.Public.Stories.Item.Comics {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\stories\{storyId}\comics
    /// </summary>
    public class ComicsRequestBuilder : BaseRequestBuilder {
        ...
        public ComicsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/stories/{storyId}/comics{?format*,formatType*,noVariants*,dateDescriptor*,dateRange*,title*,titleStartsWith*,startYear*,issueNumber*,diamondCode*,digitalId*,upc*,isbn*,ean*,issn*,hasDigitalIssue*,modifiedSince*,creators*,characters*,series*,events*,sharedAppearances*,collaborators*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ComicsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ComicsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/stories/{storyId}/comics{?format*,formatType*,noVariants*,dateDescriptor*,dateRange*,title*,titleStartsWith*,startYear*,issueNumber*,diamondCode*,digitalId*,upc*,isbn*,ean*,issn*,hasDigitalIssue*,modifiedSince*,creators*,characters*,series*,events*,sharedAppearances*,collaborators*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
