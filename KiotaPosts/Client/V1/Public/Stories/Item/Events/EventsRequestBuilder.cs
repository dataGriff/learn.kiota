...
using System;
namespace KiotaPosts.Client.V1.Public.Stories.Item.Events {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\stories\{storyId}\events
    /// </summary>
    public class EventsRequestBuilder : BaseRequestBuilder {
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/stories/{storyId}/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,series*,comics*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/stories/{storyId}/events{?name*,nameStartsWith*,modifiedSince*,creators*,characters*,series*,comics*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
