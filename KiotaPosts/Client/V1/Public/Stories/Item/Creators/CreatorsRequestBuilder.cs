...
using System;
namespace KiotaPosts.Client.V1.Public.Stories.Item.Creators {
    /// <summary>
    /// Builds and executes requests for operations under \v1\public\stories\{storyId}\creators
    /// </summary>
    public class CreatorsRequestBuilder : BaseRequestBuilder {
        ...
        public CreatorsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/stories/{storyId}/creators{?firstName*,middleName*,lastName*,suffix*,nameStartsWith*,firstNameStartsWith*,middleNameStartsWith*,lastNameStartsWith*,modifiedSince*,comics*,series*,events*,orderBy*,limit*,offset*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreatorsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreatorsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/public/stories/{storyId}/creators{?firstName*,middleName*,lastName*,suffix*,nameStartsWith*,firstNameStartsWith*,middleNameStartsWith*,lastNameStartsWith*,modifiedSince*,comics*,series*,events*,orderBy*,limit*,offset*}", rawUrl) {
        }
        /// <summary>
